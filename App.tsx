...
const DataProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    localStorage.setItem("dd_news", JSON.stringify(news));
  }, [news]);
  useEffect(() => {
    localStorage.setItem("dd_portfolio", JSON.stringify(portfolio));
  }, [portfolio]);
  useEffect(() => {
  ...
  const updateProduct = (id: string, item: Partial<Product>) =>
    setProducts(products.map((p) => (p.id === id ? { ...p, ...item } : p)));
  ...
  const updateNews = (id: string, item: Partial<NewsArticle>) =>
    setNews(news.map((n) => (n.id === id ? { ...n, ...item } : n)));
  ...
  const updatePortfolio = (id: string, item: Partial<PortfolioItem>) =>
    setPortfolio(portfolio.map((p) => (p.id === id ? { ...p, ...item } : p)));
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-white dark:bg-paper rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative animate-scale-up border border-white/20">
        <div className="sticky top-0 bg-white/95 dark:bg-paper/95 backdrop-blur p-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center z-10">
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors text-gray-500 hover:text-red-500"
          >
            <X size={20} />
          </button>
        </div>
...
const Sidebar: React.FC<{
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-darker shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0 border-r border-gray-200 dark:border-gray-800 flex flex-col`}
      >
        <div className="p-6 border-b border-gray-100 dark:border-gray-800">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-8 h-8 bg-gradient-to-br from-primary to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-xl group-hover:rotate-12 transition-transform">
              D
            </div>
            <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-600 font-sans tracking-tight">
              DarkDesigner
            </span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-100 dark:border-gray-800">
          <Link
            to="/admin"
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          >
            <Lock size={18} />
    ...
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-lg leading-relaxed">
              ...
              , a Software Engineer & Graphic Designer bridging the gap between
              functional code and beautiful design.
            </p>
            <div className="flex flex-wrap gap-4 pt-4">
              <button
                onClick={() => navigate("/creative")}
                className="px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl font-bold hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
              >
                View Portfolio <ArrowRight size={20} />
              </button>
              <button
                onClick={() => navigate("/contact")}
                className="px-8 py-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl font-bold hover:border-primary hover:text-primary transition-all duration-300"
              >
                Contact Me
              </button>
            </div>
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative w-full max-w-md mx-auto aspect-square">
              ...
              <img
                src="https://scontent.fdac207-1.fna.fbcdn.net/v/t39.30808-1/457755090_487167044243615_3573487624675178014_n.jpg?stp=dst-jpg_s480x480_tt6&_nc_cat=105&ccb=1-7&_nc_sid=1d2534&_nc_ohc=_W6Nn-YP-gAQ7kNvwEtpa8x&_nc_oc=AdnajKtpHfotxKM0xsk9MNYUpSCae-Et1hzLbq73U8jLiaCJEmgaO8qnXxeEnuu66Io&_nc_zt=24&_nc_ht=scontent.fdac207-1.fna&_nc_gid=ozmtX1Oc_w9oQaOI8zvRRA&oh=00_AfiBuFk_xdtYge0lmiG4_49Pr-RYWXoJkS-sMSPqkheygA&oe=692CB0C4"
                alt="Profile"
              ...
              {/* Floating Cards */}
              <div
                className="absolute -bottom-6 -left-6 bg-white dark:bg-paper p-4 rounded-xl shadow-xl z-20 animate-bounce"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold">
                      {USER_PROFILE.experienceYearsWeb}+ Years
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div
                className="absolute -top-6 -right-6 bg-white dark:bg-paper p-4 rounded-xl shadow-xl z-20 animate-bounce"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 py-12">
        <div
          ...
          className="bg-white dark:bg-paper p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 hover:shadow-2xl hover:-translate-y-2 transition-all cursor-pointer group"
        >
          ...
          <p className="text-gray-500 text-sm">
            Browse exclusive products & gadgets.
          </p>
        </div>
    ...
    <div className="min-h-screen">
      ...
      <div className="flex justify-center mb-10">
        <div className="bg-white dark:bg-paper rounded-2xl p-2 shadow-sm border border-gray-100 dark:border-gray-800 inline-flex">
          <button
            ...
            className={`px-8 py-3 rounded-xl transition-all font-bold flex items-center gap-2 ${
              activeTab === "ecommerce"
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white dark:bg-paper rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800 flex flex-col group overflow-hidden"
                >
                  <div
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                      <span className="text-white border-2 border-white px-6 py-2 rounded-full font-bold">
                        Quick View
                      </span>
                    </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <h3
                      className="font-bold text-lg mb-2 truncate group-hover:text-primary transition-colors"
                      onClick={() => setSelectedProduct(product)}
                    >
                      {product.title}
                    </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {news.map((article, idx) => (
            <div
              ...
              className={`bg-white dark:bg-paper rounded-2xl shadow-sm hover:shadow-xl transition-all cursor-pointer overflow-hidden group ${
                idx === 0 ? "md:col-span-2 lg:col-span-2" : ""
              }`}
            >
              <div
                className={`relative overflow-hidden ${
                  idx === 0 ? "h-64 md:h-96" : "h-48"
                }`}
              >
                <img
                  src={article.image}
              ...
              <div className="p-6">
                ...
                <h3
                  ...
                  } font-bold mb-3 group-hover:text-primary transition-colors leading-tight`}
                >
                  {article.title}
                </h3>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-lg flex flex-col justify-center items-center text-center">
            ...
            <p className="opacity-80 mb-6">
              Get the latest tech and design news delivered to your inbox.
            </p>
            <input
              type="email"
              placeholder="Your Email"
              className="w-full bg-white/10 border border-white/20 rounded-xl p-3 mb-4 text-white placeholder-white/50 focus:outline-none focus:border-primary"
            />
            <button className="w-full bg-primary text-white font-bold py-3 rounded-xl hover:bg-blue-600 transition-colors">
              Subscribe
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              <img
                ...
                className="w-full rounded-2xl shadow-lg bg-gray-50"
              />
            </div>
            <div className="md:w-1/2 flex flex-col">
              <div className="flex items-center gap-3 mb-4">
                <span className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wide">
              ...
              <div className="mt-auto bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="px-6 py-4 rounded-xl font-bold border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all"
                  >
                    Add to Cart
                  </button>
                  <button
                    ...
                    className="px-6 py-4 rounded-xl font-bold bg-primary text-white hover:bg-blue-600 shadow-lg shadow-blue-500/30 transition-all"
                  >
                    Buy Now
                  </button>
                </div>
          ...
          <article>
            ...
            <div className="flex items-center gap-6 mb-8 border-b border-gray-100 dark:border-gray-800 pb-6">
              <span className="flex items-center gap-2 text-primary font-bold">
                <List size={18} /> {selectedArticle.category}
              </span>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {cart.length === 0 ? (
                ...
                cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex gap-4 items-center bg-white dark:bg-gray-900 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800"
                  >
                    <img
                      src={item.image}
                      alt={item.title}
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <span className="font-bold text-sm bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
                        {item.quantity}
                      </span>
                      <button
      ...
      >
        <form onSubmit={handleCheckoutSubmit} className="space-y-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full p-3 rounded-xl border bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary outline-none transition-all"
                />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-500">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-3 rounded-xl border bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary outline-none transition-all h-24"
              ></textarea>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  onChange={() =>
                    setOrderForm({ ...orderForm, payment: "cod" })
                  }
                  className="hidden"
                />
                <div
              ...
              >
                <input
                  ...
                  onChange={() =>
                    setOrderForm({ ...orderForm, payment: "card" })
                  }
                  className="hidden"
                />
                <div
          ...
          <button
            type="submit"
            className="w-full bg-green-500 text-white py-4 rounded-xl font-bold text-lg hover:bg-green-600 shadow-lg shadow-green-500/30 transition-all transform hover:scale-[1.01]"
          >
            Confirm Order - ৳
    ...
    <div className="min-h-screen">
      <div className="text-center mb-16 space-y-4">
        <h1 className="text-4xl md:text-5xl font-black mb-2">
          My <span className="text-primary">Creative</span> Space
        </h1>
        <p className="text-gray-500 max-w-2xl mx-auto">
          Explore my latest works in graphic design and web development. Each
          ...
          <button
            ...
            className={`flex items-center gap-3 px-8 py-4 rounded-2xl font-bold transition-all border-2 ${
              category === "graphic"
                ...
                : "border-transparent bg-white dark:bg-paper shadow-md hover:shadow-lg"
            }`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredItems.map((item) => (
          <div
            ...
            className="group bg-white dark:bg-paper rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer border border-gray-100 dark:border-gray-800"
          >
        ...
        {selectedItem && (
          <div className="space-y-8">
            <img
              ...
              className="w-full rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700"
            />
            <div>
              <div className="flex items-center gap-4 mb-6">
                <span
                  className={`px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wide text-white ${
                    selectedItem.category === "graphic"
                      ? "bg-purple-600"
                      : "bg-orange-600"
                  }`}
                >
                ...
                <span className="bg-gray-100 dark:bg-gray-700 px-4 py-1.5 rounded-full text-sm font-bold">
    ...
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto bg-white dark:bg-paper rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-800">
        <div className="h-80 relative">
          <img
            src="https://scontent.fdac207-1.fna.fbcdn.net/v/t39.30808-6/476441936_603723025921349_565797681915138555_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=thDLWfNSI9wQ7kNvwGg-WZD&_nc_oc=AdlhbuO877JvmnUxzzoD7cawnjMAWv9YLzrNhud74C5Ng4ykyXFklXpZIPuBPAV6fnI&_nc_zt=23&_nc_ht=scontent.fdac207-1.fna&_nc_gid=ozmtX1Oc_w9oQaOI8zvRRA&oh=00_Afg7VjrFcCIf48k7-vQJLtbEptEqEVRz686Rq3B_OFxQhA&oe=692C8F40"
            alt="Banner"
            className="w-full h-full object-cover"
          />
          ...
          <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 p-2 bg-white dark:bg-paper rounded-full shadow-xl z-10">
            <img
              src="https://scontent.fdac207-1.fna.fbcdn.net/v/t39.30808-1/457755090_487167044243615_3573487624675178014_n.jpg?stp=dst-jpg_s480x480_tt6&_nc_cat=105&ccb=1-7&_nc_sid=1d2534&_nc_ohc=_W6Nn-YP-gAQ7kNvwEtpa8x&_nc_oc=AdnajKtpHfotxKM0xsk9MNYUpSCae-Et1hzLbq73U8jLiaCJEmgaO8qnXxeEnuu66Io&_nc_zt=24&_nc_ht=scontent.fdac207-1.fna&_nc_gid=ozmtX1Oc_w9oQaOI8zvRRA&oh=00_AfiBuFk_xdtYge0lmiG4_49Pr-RYWXoJkS-sMSPqkheygA&oe=692CB0C4"
              alt="Profile"
              className="w-40 h-40 rounded-full object-cover border-4 border-gray-100 dark:border-gray-700"
            />
          </div>
        </div>
        ...
        <div className="pt-24 px-8 md:px-16 pb-16 text-center">
          ...
          <p className="text-xl text-primary font-medium mb-8">
            {USER_PROFILE.title} @ {USER_PROFILE.company}
          </p>

          <div className="prose dark:prose-invert max-w-3xl mx-auto mb-12 text-lg text-gray-600 dark:text-gray-300">
            <p>
              Hello! I am a passionate software engineer and graphic designer
              with over{" "}
              <span className="font-bold text-gray-900 dark:text-white">
                {USER_PROFILE.experienceYearsWeb} years
              </span>{" "}
              of experience in web development and{" "}
              <span className="font-bold text-gray-900 dark:text-white">
                {USER_PROFILE.experienceYearsGraphic} years
              </span>{" "}
              in graphic design.
            </p>
            <p>
              ...
              , where I honed my technical skills. Currently, I am delivering
              high-quality solutions at {USER_PROFILE.company}.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-10 text-left">
            <div className="bg-blue-50 dark:bg-blue-900/10 p-8 rounded-2xl">
              <h3 className="font-bold text-xl mb-6 flex items-center gap-3 text-blue-700 dark:text-blue-400">
              ...
              <div className="flex flex-wrap gap-2">
                {USER_PROFILE.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-white dark:bg-paper shadow-sm rounded-lg text-sm font-bold text-gray-700 dark:text-gray-200"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="bg-purple-50 dark:bg-purple-900/10 p-8 rounded-2xl">
              <h3 className="font-bold text-xl mb-6 flex items-center gap-3 text-purple-700 dark:text-purple-400">
                <PenTool size={24} /> Design Skills
              </h3>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-paper p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                ...
                <div className="flex gap-3">
                  <a
                    href={USER_PROFILE.social.facebook}
                    target="_blank"
                    className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-primary hover:text-white transition-all"
                  >
                    <Facebook size={18} />
                  </a>
                  <a
                    href={USER_PROFILE.social.linkedin}
                    target="_blank"
                    className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-primary hover:text-white transition-all"
                  >
                    <Linkedin size={18} />
                  ...
                  <a
                    href={USER_PROFILE.social.dribbble}
                    target="_blank"
                    className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-primary hover:text-white transition-all"
                  >
                    <Dribbble size={18} />
                  ...
                  <a
                    href={USER_PROFILE.social.github}
                    target="_blank"
                    className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-primary hover:text-white transition-all"
                  >
                    <Github size={18} />
          ...
          <div className="lg:col-span-2">
            <form
              ...
              className="bg-white dark:bg-paper p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800"
            >
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-4 rounded-xl bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 focus:border-primary outline-none transition-colors"
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-xl bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 focus:border-primary outline-none transition-colors h-40"
                  placeholder="Tell me about your project..."
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full bg-primary text-white font-bold py-4 rounded-xl hover:bg-blue-600 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Send Message
              </button>
            </form>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-darker p-4">
      <div className="bg-white dark:bg-paper p-8 rounded-2xl shadow-2xl w-full max-w-md border border-gray-200 dark:border-gray-700">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-xl border dark:bg-gray-800 dark:border-gray-700 focus:border-primary outline-none"
              placeholder="admin"
            />
          </div>
          <div>
        ...
        <div className="mt-4 text-center">
          <Link
            to="/"
            className="text-sm text-primary hover:underline font-bold flex items-center justify-center gap-1"
          >
...
const Admin: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "orders" | "products" | "news" | "portfolio" | "messages"
  >("dashboard");
  const [editItem, setEditItem] = useState<any>(null);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [formType, setFormType] = useState<"product" | "news" | "portfolio">(
    "product"
  );
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (formType === "product") {
      const productData = {
        ...
        image:
          formData.image ||
          "https://placehold.co/400x400/1e293b/ffffff?text=Product",
      ...
      const newsData = {
        ...
        image:
          formData.image ||
          "https://placehold.co/600x400/1e293b/ffffff?text=News",
      ...
      const defaultSub =
        cat === "graphic" ? GRAPHIC_SUB_CATEGORIES[0] : WEB_SUB_CATEGORIES[0];
        ...
        <thead className="bg-gray-50 dark:bg-gray-800">
          <tr>
            {columns.map((col: any) => (
              <th
                key={col.key}
                className="p-4 font-bold text-sm text-gray-600 dark:text-gray-300"
              >
                {col.label}
              </th>
            ))}
            <th className="p-4 text-right font-bold text-sm text-gray-600 dark:text-gray-300">
              Actions
            </th>
          </tr>
        </thead>
            ...
            >
              ...
              <td className="p-4 text-right">
                <div className="flex justify-end gap-2">
                  <button
                    onClick={() => onEdit(item)}
                    className="text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900/30 p-2 rounded transition-colors"
                  >
                    <Edit size={16} />
                  </button>
                  <button
                    onClick={() => onDelete(item.id)}
                    className="text-red-500 hover:bg-red-100 dark:hover:bg-red-900/30 p-2 rounded transition-colors"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-lg">
                  <h3 className="text-sm font-bold opacity-80 uppercase tracking-wide">
                    Total Revenue
                  </h3>
              ...
              <RenderTable
                columns={[
                  ...
                  },
                  {
                    ...
                    label: "Payment",
                    render: (val: string) => (
                      <span className="uppercase text-xs font-bold px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded">
                        {val}
                      </span>
                    ),
                  },
                  {
                    ...
                    render: (val: string) => (
                      <span
                        className={`uppercase text-xs font-bold px-2 py-1 rounded ${
                          val === "pending"
            ...
            <div className="animate-fade-in-up">
              <div className="flex justify-between items-center mb-8">
                ...
                <button
                  ...
                  className="bg-primary text-white px-6 py-3 rounded-xl flex items-center gap-2 font-bold shadow-lg shadow-blue-500/30 hover:bg-blue-600 transition-all"
                >
              ...
              <RenderTable
                columns={[
                  ...
                  },
                  {
                    ...
                    label: "Type",
                    render: (t: string) => (
                      <span className="uppercase text-xs font-bold px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">
                        {t}
                      </span>
                    ),
                  },
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="grid gap-4">
                {messages.map((msg) => (
                  <div
                    key={msg.id}
                    className="bg-white dark:bg-paper p-6 rounded-xl shadow-sm border border-l-4 border-l-primary hover:shadow-md transition-shadow"
                  >
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
            ...
            <div className="flex flex-col items-center">
              {formData.image ? (
                <img
                  src={formData.image}
                  alt="Preview"
                  className="h-40 object-contain mb-2 rounded-lg shadow-sm"
                />
              ) : (
          ...
          {formType === "portfolio" && (
            <div className="grid grid-cols-2 gap-4">
              <select
                required
                value={formData.category || "graphic"}
                onChange={(e) =>
                  setFormData({
                    ...formData,
          ...
          <textarea
            ...
            className="w-full p-3 rounded-xl border dark:bg-gray-800 dark:border-gray-700 h-32"
          ></textarea>

          <button
            type="submit"
            className="w-full bg-primary text-white py-4 rounded-xl font-bold hover:bg-blue-600 transition-colors shadow-lg"
          >
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-darker transition-colors duration-300">
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen transition-all duration-300">
        ...
        {/* Main Content Area */}
        <main className="flex-1 p-6 lg:p-10 animate-fade-in">{children}</main>
        ...
        <footer className="bg-white dark:bg-paper border-t border-gray-200 dark:border-gray-800 py-8 px-6 text-center">
          <p className="text-gray-500 dark:text-gray-400 font-medium">
            ...
            <span className="text-primary font-bold">DarkDesigner</span>. All
            rights reserved.
          </p>
          <p className="text-sm text-gray-400 mt-2">
            Crafted by MD Salman Islam
          </p>
        </footer>
      </div>
    </div>
